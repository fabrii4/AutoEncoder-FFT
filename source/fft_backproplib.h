...
void backprop_fft(std::vector<std::vector<std::vector<float> > >& in, std::vector<std::vector<std::vector<float> > >& expout, std::vector<std::vector<std::vector<float> > >& out, std::vector<float>& cfreq, std::vector<std::vector<std::vector<std::vector<float> > > >& c, std::vector<float>& ffreq, std::vector<std::vector<std::vector<std::vector<float> > > >& f,  std::vector<float>& b, std::vector<float>& p, int dM, float del0, int maxdiff);
